...
<head>
  ...
  <style>
    * { box-sizing: border-box; }
    ...
    /* Visual Builder Drag Item */
    .builder-section-item { background: #0b1120; border: 1px solid #1e293b; border-radius: 12px; padding: 14px 18px; display: flex; align-items: center; justify-content: space-between; transition: all 0.2s; user-select: none; }
    .builder-section-item:hover { border-color: #00D2FF66; background: #0e172a; }
    ...
    <div id="tab-builder" style="display: none; max-width: 960px; margin: 0 auto;">
      <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 20px; flex-wrap: wrap; gap: 12px;">
        <div>
          ...
          <p style="color: #64748b; font-size: 12px; margin-top: 4px;">تحكم في ترتيب الأقسام بالتحريك، أبعاد وتمدد الصور والبنرات، وربط أزرار الموقع والواتساب</p>
        </div>
      ...
      <div style="display: flex; flex-direction: column; gap: 24px;">
          ...
          <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 14px;">
            <div>
              <h3 style="color: #fff; font-size: 15px; font-weight: 800; margin: 0; display: flex; align-items: center; gap: 8px;">
                <i class="fas fa-up-down-left-right" style="color: #00D2FF;"></i> 1. ترتيب وظهور أقسام المتجر في الصفحة الرئيسية
              </h3>
              <p style="color: #64748b; font-size: 11.5px; margin-top: 2px;">استخدم أزرار الأسهم لتحريك أي قسم للأعلى أو للأسفل بسلاسة، وزر العين لإظهاره أو إخفائه</p>
            </div>
          </div>
          <div id="builder-sections-list" style="display: flex; flex-direction: column; gap: 10px;"></div>
        </div>

        <!-- 2. Hero Banner & Image Stretch Customizer -->
        <div class="glass-card" style="padding: 20px;">
          <h3 style="color: #fff; font-size: 15px; font-weight: 800; margin: 0 0 4px; display: flex; align-items: center; gap: 8px;">
            <i class="fas fa-image" style="color: #38bdf8;"></i> 2. البنر الإعلاني الرئيسي وتمدد الصور (Banner & Stretch)
          </h3>
          <p style="color: #64748b; font-size: 11.5px; margin-bottom: 18px;">تعديل صورة البنر الرئيسي، طريقة تمددها وملاءمتها للمربع، ونصوص وأزرار البنر</p>

          <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
            <!-- Banner Image Box & Sizing -->
            <div>
              <label style="display: block; font-size: 12px; font-weight: 700; color: #94a3b8; margin-bottom: 6px;">📷 صورة البنر الإعلاني</label>
              <div class="img-upload-box" id="builder-banner-img-box" onclick="triggerUpload('builder-banner')" ondragover="dragOverHandler(event)" ondragleave="dragLeaveHandler(event)" ondrop="dropHandler(event, 'builder-banner')" style="min-height: 180px; position: relative;">
                <img id="builder-banner-preview-img" src="assets/images/hero_banner_1_refined.jpg" style="width: 100%; height: 180px; object-fit: cover;">
              </div>
              <input type="text" id="builder-banner-img-url" class="admin-input" style="margin-top: 8px; font-size: 12px;" placeholder="رابط صورة البنر..." oninput="previewBuilderBannerUrl()">
              ...
              <div style="margin-top: 14px;">
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 6px;">
                  <button type="button" class="fit-btn active" id="fit-btn-cover" onclick="setBannerFit('cover')">
                    <i class="fas fa-crop-simple"></i> تغطية وتناسب (Cover)
                  </button>
                  <button type="button" class="fit-btn" id="fit-btn-contain" onclick="setBannerFit('contain')">
                    <i class="fas fa-expand"></i> احتواء كامل (Contain)
                  </button>
                  <button type="button" class="fit-btn" id="fit-btn-fill" onclick="setBannerFit('fill')">
                    <i class="fas fa-up-right-and-down-left-from-center"></i> تمدد كامل (Stretch)
                  </button>
                </div>
              </div>

              <!-- Banner Height Dimension -->
              <div style="margin-top: 14px;">
                <label style="display: block; font-size: 11px; font-weight: 700; color: #94a3b8; margin-bottom: 6px;">📏 ارتفاع مربع البنر في الصفحة:</label>
                <div style="display: grid; grid-template-columns: 1fr 1fr 1fr 1fr; gap: 6px;">
                  <button type="button" class="fit-btn" id="height-btn-260" onclick="setBannerHeight('260px')">260px (صغير)</button>
                  <button type="button" class="fit-btn active" id="height-btn-380" onclick="setBannerHeight('380px')">380px (متوسط)</button>
                  <button type="button" class="fit-btn" id="height-btn-480" onclick="setBannerHeight('480px')">480px (كبير)</button>
                  <button type="button" class="fit-btn" id="height-btn-auto" onclick="setBannerHeight('auto')">تلقائي</button>
                </div>
              </div>
            </div>

            <!-- Banner Texts & CTA Button -->
            <div style="display: flex; flex-direction: column; gap: 12px;">
              <div>
                <label style="display: block; font-size: 11.5px; font-weight: 700; color: #94a3b8; margin-bottom: 4px;">📌 عنوان البنر الرئيسي</label>
                <input type="text" id="builder-banner-title" class="admin-input" value="حلول الاتصالات الفضائية واللاسلكية والملاحة في المملكة">
              </div>
              <div>
                <label style="display: block; font-size: 11.5px; font-weight: 700; color: #94a3b8; margin-bottom: 4px;">📝 النص التوضيحي للبنر</label>
                <textarea id="builder-banner-desc" class="admin-input" rows="3" style="resize: vertical;">مؤسسة برق سهيل التجارية وجهتكم الرائدة لتجهيز الرحلات البرية والبحرية بأحدث هواتف الثريا، أجهزة اللاسلكي المرخصة من هيئة الاتصالات (CST)، وملاحة وخرائط قارمن مع الضمان والدعم الفني المباشر بالدمام.</textarea>
              </div>
              <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 10px;">
                <div>
                  <label style="display: block; font-size: 11.5px; font-weight: 700; color: #34d399; margin-bottom: 4px;">🔘 نص زر البنر الرئيسي</label>
                  <input type="text" id="builder-banner-btn-text" class="admin-input" value="تصفح كتالوج الأجهزة">
                </div>
                <div>
                  <label style="display: block; font-size: 11.5px; font-weight: 700; color: #34d399; margin-bottom: 4px;">🔗 رابط الزر</label>
                  <input type="text" id="builder-banner-btn-link" class="admin-input" value="#products" style="direction: ltr; font-family: monospace;">
                </div>
              </div>
            </div>
          </div>
        ...
        <!-- 3. Button Actions & WhatsApp Customizer -->
        <div class="glass-card" style="padding: 20px;">
          <h3 style="color: #fff; font-size: 15px; font-weight: 800; margin: 0 0 4px; display: flex; align-items: center; gap: 8px;">
            <i class="fas fa-link" style="color: #4ade80;"></i> 3. ربط أزرار الموقع والواتساب (Buttons & WhatsApp)
          </h3>
          <p style="color: #64748b; font-size: 11.5px; margin-bottom: 16px;">تحديد وجهات ونصوص أزرار المتجر ورقم ورسالة الواتساب</p>
          ...
          <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px;">
            ...
            <div style="background: rgba(7,12,24,0.6); border: 1px solid #1e293b; border-radius: 12px; padding: 14px;">
              ...
              <div style="display: flex; flex-direction: column; gap: 8px;">
                ...
                <div>
                  <label style="display: block; font-size: 11px; font-weight: 700; color: #94a3b8; margin-bottom: 4px;">رابط الزر (URL أو معرف قسم)</label>
            ...
            <div style="background: rgba(7,12,24,0.6); border: 1px solid #1e293b; border-radius: 12px; padding: 14px;">
              ...
              <div style="display: flex; flex-direction: column; gap: 8px;">
                ...
                <div>
                  <label style="display: block; font-size: 11px; font-weight: 700; color: #94a3b8; margin-bottom: 4px;">رسالة الترحيب الافتتاحية التلقائية</label>
        ...
        <!-- 4. Grid Density & Columns -->
        <div class="glass-card" style="padding: 20px;">
          <h3 style="color: #fff; font-size: 15px; font-weight: 800; margin: 0 0 4px; display: flex; align-items: center; gap: 8px;">
            <i class="fas fa-table-cells-large" style="color: #c084fc;"></i> 4. كثافة وأعمدة شبكة المنتجات (Catalog Grid Layout)
          </h3>
          <p style="color: #64748b; font-size: 11.5px; margin-bottom: 14px;">اختر عدد أعمدة عرض كروت المنتجات على الشاشات الكبيرة</p>

          <div style="display: grid; grid-template-columns: repeat(4, 1fr); gap: 10px;">
            <button type="button" class="fit-btn" id="grid-cols-3" onclick="setGridCols('3')">
              <div style="font-size: 14px; font-weight: 800;">3 أعمدة</div>
              <div style="font-size: 10px; color: #64748b;">كروت كبيرة وعريضة</div>
            </button>
            <button type="button" class="fit-btn" id="grid-cols-4" onclick="setGridCols('4')">
              <div style="font-size: 14px; font-weight: 800;">4 أعمدة</div>
              <div style="font-size: 10px; color: #64748b;">كروت متوسطة متوازنة</div>
            </button>
            <button type="button" class="fit-btn active" id="grid-cols-5" onclick="setGridCols('5')">
              <div style="font-size: 14px; font-weight: 800;">5 أعمدة (افتراضي)</div>
              <div style="font-size: 10px; color: #64748b;">مدمجة وعالية الكثافة</div>
            </button>
            <button type="button" class="fit-btn" id="grid-cols-6" onclick="setGridCols('6')">
              <div style="font-size: 14px; font-weight: 800;">6 أعمدة</div>
              <div style="font-size: 10px; color: #64748b;">أقصى سعة للمنتجات</div>
            </button>
          </div>
        </div>
...
var DEFAULT_SECTIONS_META = [
  { id: 'home', title: 'البنر الإعلاني الرئيسي (Hero Banner)', icon: 'fas fa-image' },
  { id: 'section-features', title: 'شريط المميزات والضمان (Features Strip)', icon: 'fas fa-shield-halved' },
  { id: 'products', title: 'كتالوج المنتجات والفئات (Products Catalog)', icon: 'fas fa-boxes-stacked' },
  { id: 'thuraya', title: 'قسم هواتف وأجهزة الثريا (Thuraya Spotlight)', icon: 'fas fa-satellite' },
  { id: 'garmin', title: 'قسم قارمن والملاحة والخرائط (Garmin GPS)', icon: 'fas fa-map-location-dot' },
  { id: 'b2b', title: 'نموذج طلب عروض الأسعار (B2B Quote Request)', icon: 'fas fa-file-invoice' },
  { id: 'showroom', title: 'بطاقة المعرض وخريطة الدمام (Showroom Card)', icon: 'fas fa-store' }
];
...
function populateBuilderUI() {
  ...
  if (previewImg && b.image) previewImg.src = b.image;
  if (urlInp && b.image) urlInp.value = b.image;
  if (document.getElementById('builder-banner-title')) document.getElementById('builder-banner-title').value = b.title || '';
  if (document.getElementById('builder-banner-desc')) document.getElementById('builder-banner-desc').value = b.desc || '';
  if (document.getElementById('builder-banner-btn-text')) document.getElementById('builder-banner-btn-text').value = b.btnText || '';
  if (document.getElementById('builder-banner-btn-link')) document.getElementById('builder-banner-btn-link').value = b.btnLink || '';

  setBannerFit(b.fit || 'cover', false);
  setBannerHeight(b.height || '380px', false);
  ...
  setGridCols(lay.gridCols || '5', false);
}
...
function renderBuilderSectionsList() {
  ...
  container.innerHTML = order.map(function(secId, idx) {
    ...
    return '<div class="builder-section-item ' + (isVisible ? '' : 'hidden-sec') + '">' +
      '<div style="display: flex; align-items: center; gap: 12px;">' +
        '<div style="width: 32px; height: 32px; border-radius: 8px; background: rgba(0,210,255,0.1); color: #00D2FF; display: flex; align-items: center; justify-content: center; font-size: 14px;">' +
          '<i class="' + meta.icon + '"></i>' +
        '</div>' +
        '<div>' +
          '<div style="color: #fff; font-size: 13.5px; font-weight: 700;">' + meta.title + '</div>' +
          '<div style="color: #64748b; font-size: 11px; font-family: monospace;">معرف القسم: #' + meta.id + '</div>' +
        '</div>' +
      '</div>' +
      '<div style="display: flex; align-items: center; gap: 8px;">' +
        '<span style="font-size: 11px; font-weight: 700; padding: 3px 8px; border-radius: 6px; ' + (isVisible ? 'background:rgba(52,211,153,0.15);color:#34d399;' : 'background:rgba(239,68,68,0.15);color:#f87171;') + '">' + (isVisible ? 'ظاهر' : 'مخفي') + '</span>' +
...
function saveThemeBuilderConfig() {
  if (!currentThemeConfig.banner) currentThemeConfig.banner = {};
  currentThemeConfig.banner.image = (document.getElementById('builder-banner-img-url').value || '').trim() || currentThemeConfig.banner.image;
...
print('admin.html with Visual Theme & Layout Builder generated successfully! Length:', len(content))
